...
class Args:
    ...
    def parse(self, argv: Sequence[str], meta: dict[str, Any]) -> tuple[dict[str, Any], CustomArgumentParser, list[str]]:
        ...
        parser.add_argument("-n", "--note", dest="personal_note", nargs="+", required=False, help="Custom note to add to description (French and UNIT3D trackers only). Absolute path to a file or text")
        parser.add_argument(
            "-menus",
            "--disc-menus",
